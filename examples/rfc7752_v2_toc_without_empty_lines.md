...
`   `[`2`](#section-2)`. Motivation and Applicability`
`      `[`2.1`](#section-2-1)`. MPLS-TE with PCE`
`      `[`2.2`](#section-2-2)`. ALTO Server Network API`
`   `[`3`](#section-3)`. Carrying Link-State Information in BGP`
`      `[`3.1`](#section-3-1)`. TLV Format`
`      `[`3.2`](#section-3-2)`. The Link-State NLRI`
`           `[`3.2.1`](#section-3-2-1)`. Node Descriptors`
`           `[`3.2.2`](#section-3-2-2)`. Link Descriptors`
`           `[`3.2.3`](#section-3-2-3)`. Prefix Descriptors`
`      `[`3.3`](#section-3-3)`. The BGP-LS Attribute`
`           `[`3.3.1`](#section-3-3-1)`. Node Attribute TLVs`
`           `[`3.3.2`](#section-3-3-2)`. Link Attribute TLVs`
`           `[`3.3.3`](#section-3-3-3)`. Prefix Attribute TLVs`
`      `[`3.4`](#section-3-4)`. BGP Next-Hop Information`
`      `[`3.5`](#section-3-5)`. Inter-AS Links`
`      `[`3.6`](#section-3-6)`. Router-ID Anchoring Example: ISO Pseudonode`
`      `[`3.7`](#section-3-7)`. Router-ID Anchoring Example: OSPF Pseudonode`
`      `[`3.8`](#section-3-8)`. Router-ID Anchoring Example: OSPFv2 to IS-IS Migration`
`   `[`4`](#section-4)`. Link to Path Aggregation`
`      `[`4.1`](#section-4-1)`. Example: No Link Aggregation`
`      `[`4.2`](#section-4-2)`. Example: ASBR to ASBR Path Aggregation`
`      `[`4.3`](#section-4-3)`. Example: Multi-AS Path Aggregation`
`   `[`5`](#section-5)`. IANA Considerations`
`      `[`5.1`](#section-5-1)`. Guidance for Designated Experts`
`   `[`6`](#section-6)`. Manageability Considerations`
`      `[`6.1`](#section-6-1)`. Operational Considerations`
`           `[`6.1.1`](#section-6-1-1)`. Operations`
`           `[`6.1.2`](#section-6-1-2)`. Installation and Initial Setup`
`           `[`6.1.3`](#section-6-1-3)`. Migration Path`
`           `[`6.1.4`](#section-6-1-4)`. Requirements on Other Protocols and`
`                  Functional Components`
`           `[`6.1.5`](#section-6-1-5)`. Impact on Network Operation`
`           `[`6.1.6`](#section-6-1-6)`. Verifying Correct Operation`
`      `[`6.2`](#section-6-2)`. Management Considerations`
`           `[`6.2.1`](#section-6-2-1)`. Management Information`
`           `[`6.2.2`](#section-6-2-2)`. Fault Management`
`           `[`6.2.3`](#section-6-2-3)`. Configuration Management`
`           `[`6.2.4`](#section-6-2-4)`. Accounting Management`
`           `[`6.2.5`](#section-6-2-5)`. Performance Management`
`           `[`6.2.6`](#section-6-2-6)`. Security Management`
`   `[`7`](#section-7)`. TLV/Sub-TLV Code Points Summary`
...
`<a id="section-2"></a>2. Motivation and Applicability`
...
`<a id="section-2-1"></a>2.1. MPLS-TE with PCE`
...
`<a id="section-2-2"></a>2.2. ALTO Server Network API`
...
`<a id="section-3"></a>3. Carrying Link-State Information in BGP`
...
`<a id="section-3-1"></a>3.1. TLV Format`
...
`<a id="section-3-2"></a>3.2. The Link-State NLRI`
...
`<a id="section-3-2-1"></a>3.2.1. Node Descriptors`
...
`<a id="section-3-2-1-1"></a>3.2.1.1. Globally Unique Node/Link/Prefix Identifiers`
...
`<a id="section-3-2-1-2"></a>3.2.1.2. Local Node Descriptors`
...
`<a id="section-3-2-1-3"></a>3.2.1.3. Remote Node Descriptors`
...
`<a id="section-3-2-1-4"></a>3.2.1.4. Node Descriptor Sub-TLVs`
...
`<a id="section-3-2-1-5"></a>3.2.1.5. Multi-Topology ID`
...
`<a id="section-3-2-2"></a>3.2.2. Link Descriptors`
...
`<a id="section-3-2-3"></a>3.2.3. Prefix Descriptors`
...
`<a id="section-3-2-3-1"></a>3.2.3.1. OSPF Route Type`
...
`<a id="section-3-2-3-2"></a>3.2.3.2. IP Reachability Information`
...
`<a id="section-3-3"></a>3.3. The BGP-LS Attribute`
...
`<a id="section-3-3-1"></a>3.3.1. Node Attribute TLVs`
...
`<a id="section-3-3-1-1"></a>3.3.1.1. Node Flag Bits TLV`
...
`<a id="section-3-3-1-2"></a>3.3.1.2. IS-IS Area Identifier TLV`
...
`<a id="section-3-3-1-3"></a>3.3.1.3. Node Name TLV`
...
`<a id="section-3-3-1-4"></a>3.3.1.4. Local IPv4/IPv6 Router-ID TLVs`
...
`<a id="section-3-3-1-5"></a>3.3.1.5. Opaque Node Attribute TLV`
...
`<a id="section-3-3-2"></a>3.3.2. Link Attribute TLVs`
...
`<a id="section-3-3-2-1"></a>3.3.2.1. IPv4/IPv6 Router-ID TLVs`
...
`<a id="section-3-3-2-2"></a>3.3.2.2. MPLS Protocol Mask TLV`
...
`<a id="section-3-3-2-3"></a>3.3.2.3. TE Default Metric TLV`
...
`<a id="section-3-3-2-4"></a>3.3.2.4. IGP Metric TLV`
...
`<a id="section-3-3-2-5"></a>3.3.2.5. Shared Risk Link Group TLV`
...
`<a id="section-3-3-2-6"></a>3.3.2.6. Opaque Link Attribute TLV`
...
`<a id="section-3-3-2-7"></a>3.3.2.7. Link Name TLV`
...
`<a id="section-3-3-3"></a>3.3.3. Prefix Attribute TLVs`
...
`<a id="section-3-3-3-1"></a>3.3.3.1. IGP Flags TLV`
...
`<a id="section-3-3-3-2"></a>3.3.3.2. IGP Route Tag TLV`
...
`<a id="section-3-3-3-3"></a>3.3.3.3. Extended IGP Route Tag TLV`
...
`<a id="section-3-3-3-4"></a>3.3.3.4. Prefix Metric TLV`
...
`<a id="section-3-3-3-5"></a>3.3.3.5. OSPF Forwarding Address TLV`
...
`<a id="section-3-3-3-6"></a>3.3.3.6. Opaque Prefix Attribute TLV`
...
`<a id="section-3-4"></a>3.4. BGP Next-Hop Information`
...
`<a id="section-3-5"></a>3.5. Inter-AS Links`
...
`<a id="section-3-6"></a>3.6. Router-ID Anchoring Example: ISO Pseudonode`
...
`<a id="section-3-7"></a>3.7. Router-ID Anchoring Example: OSPF Pseudonode`
...
`<a id="section-3-8"></a>3.8. Router-ID Anchoring Example: OSPFv2 to IS-IS Migration`
...
`<a id="section-4"></a>4. Link to Path Aggregation`
...
`<a id="section-4-1"></a>4.1. Example: No Link Aggregation`
...
`<a id="section-4-2"></a>4.2. Example: ASBR to ASBR Path Aggregation`
...
`<a id="section-4-3"></a>4.3. Example: Multi-AS Path Aggregation`
...
`<a id="section-5-1"></a>5.1. Guidance for Designated Experts`
...
`<a id="section-6"></a>6. Manageability Considerations`
...
`<a id="section-6-1"></a>6.1. Operational Considerations`

```text

```

`<a id="section-6-1-1"></a>6.1.1. Operations`
...
`<a id="section-6-1-2"></a>6.1.2. Installation and Initial Setup`
...
`<a id="section-6-1-3"></a>6.1.3. Migration Path`
...
`<a id="section-6-1-4"></a>6.1.4. Requirements on Other Protocols and Functional Components`
...
`<a id="section-6-1-5"></a>6.1.5. Impact on Network Operation`
...
`<a id="section-6-1-6"></a>6.1.6. Verifying Correct Operation`
...
`<a id="section-6-2"></a>6.2. Management Considerations`

```text

```

`<a id="section-6-2-1"></a>6.2.1. Management Information`
...
`<a id="section-6-2-2"></a>6.2.2. Fault Management`
...
`<a id="section-6-2-3"></a>6.2.3. Configuration Management`
...
`<a id="section-6-2-4"></a>6.2.4. Accounting Management`
...
`<a id="section-6-2-5"></a>6.2.5. Performance Management`
...
`<a id="section-6-2-6"></a>6.2.6. Security Management`
...
`<a id="section-7"></a>7. TLV/Sub-TLV Code Points Summary`
...
`<a id="section-8"></a>8. Security Considerations`
